...
# # Read file and count lines files/demo.txt
file=open("files/demo.txt","r") # with open is use bcs it automatically close thefile and have error handeling
...
with open("files/demo.txt","w") as fp:
    fp.write("This will remove everthing and write a new \n")
    
# # Append logs to file
with open("files/demo.txt","a") as destinationFile,  open("files/log.txt","r")as log:
    for lines in log:
        destinationFile.write(lines)

# Remove blank lines from file
with open(
    "files/demo.txt", 'r') as readFile, open(
        'files/cleaned.txt', 'w') as writeFile:
